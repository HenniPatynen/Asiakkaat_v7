...
function lisaaTiedot(){	
	...
	document.getElementById("etunimi").value=siivoa(document.getElementById("rekNo").value);
	document.getElementById("sukunimi").value=siivoa(document.getElementById("merkki").value);
	document.getElementById("puhelin").value=siivoa(document.getElementById("vuosi").value);	
	document.getElementById("sposti").value=siivoa(document.getElementById("malli").value);
